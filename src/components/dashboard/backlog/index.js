...
const BackLog = () => {
    ...
    const backLog = sprintState && sprintState.length > 0 && sprintState.filter((item) => item.backLog == true);
    ...
    const fetchSprintTask = async (sprintId) => {
        ...
        if (res.data.success) {
            ...
            dispatch({ type: "SET_SPRINT_TASK", data: data && data });
            return data;
        } else {
    ...
    return (
        <div className="container back-log">
            <div className="button-line">
                ...
                <div className="back-log-active-btn"><p onClick={() => clickBackLog()}>Back Log</p></div>
                <div className="next-sprint-btn"><p onClick={() => clickNextSprint()}>Next Sprint</p></div>
            </div>

            <div className="back-log-screen">
                <div className="back-log-task">
                    ...
                    <div className="component-filter">
                            <div className="wrap" onClick={() => fetchBackLog()}><p>All Project</p></div>
                            {projectValue.length > 0 && projectValue.map((item, index) => {
                                return (
                    ...
                    <div className="line-1">
                        ...
                        <div className="avatar-user" ref={menuRef}>
                                <div style={{margin: "0px 10px"}} onClick={() => fetchBackLog()}>
                                    <img className="logo" src={Logo} />
                                </div>
                                {backLog && userState.length > 0 && userState.slice(0, 3).map((item, index) => {
                                    var sprintId = backLog[0]?._id;
                                    return (
                                        <div 
                    ...
                    <div className="list-task-back-log">
